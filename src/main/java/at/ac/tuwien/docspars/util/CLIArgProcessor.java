...
public class CLIArgProcessor {
  ...
  public void setProcessProps() {
    ...
    if (cl.hasOption("i")) {
      ...
      logger
          .info("SET INPUT SOURCE FOLDER TO PARAMETER MAX_DOCUMENTS TO " + cl.getOptionValue("i"));
    }
    if (cl.hasOption("st")) {
    ...
    if (cl.hasOption("v")) {
      ...
      if (db == null) {
        throw new CommandLineOptionException(
            "unknown variant of processing: " + cl.getOptionValue("v"));
      }
      pH.setVariant(db);
